...
6. Open Case Select and launch `Case_001`.
7. On the Brief tab, confirm title and briefing text match the selected case.
8. On the Scene tab, confirm the background image loads and hotspots can be discovered.
9. Find at least one clue and confirm an evidence card appears in the Evidence tab.
10. Enter the solve flow, select a claim, and confirm the results panel appears.
11. Retry the case once and confirm the scene reloads cleanly.
12. Solve correctly once and confirm the next-case flow still advances.
